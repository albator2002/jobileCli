...
export class AuthenticationService {
  ...
  login(username: String, password: String){
    ...
    .map((res : any) => {
      ...
      this.svrProfile.pr = new Profile(profile._id, profile.data.firstname,profile.data.lastname,profile.data.email,profile.data.available,profile.data.password,this.mapService.currentPos.lng,this.mapService.currentPos.lat,profile.data.worktypes);
